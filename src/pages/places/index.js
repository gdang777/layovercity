        ...
        <Modal.Body>
          ...
          <div className="d-flex justify-content-center">
            <Button
              ...
              onClick={() => {
                handleBlock(userData?._id, userData?.isBlocked ? false : true);
              }}
            >
  ...
  const TableRow = (props) => {
    ...
    return (
      <tr>
          ...
          <Dropdown>
            ...
            <Dropdown.Menu>
              <Dropdown.Item
                ...
                onClick={() => {
                  handleBlock(_id, isBlocked ? false : true);
                }}
              >
        ...
        <td>
          <span className="fw-normal">{city.country}</span>
        </td>
        <td>
          <span className="fw-normal">{city.city}</span>
        </td>
        <td>
