...
export default (props = {}) => {
  ...
  const CollapsableNavItem = (props) => {
    ...
    return (
      <Accordion className="pb-3" as={Nav.Item} defaultActiveKey={defaultKey}>
  ...
  const NavItem = (props) => {
    ...
    return (
      <Nav.Item
        className={`${navItemClassName} pb-3`}
  ...
  return (
    <>
      ...
      >
        <Navbar.Brand className="me-lg-5" as={Link} to={Routes.Users.path}>
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              ...
              >
                <NavItem
                  ...
                  link={Routes.AllResturants.path}
                />
                <NavItem
                  title="Pending Requests"
                  link={Routes.ResturantsPending.path}
                />
              </CollapsableNavItem>

              <CollapsableNavItem
                eventKey="tables/"
                title="Resturant Owners"
                icon={faTable}
              >
                <NavItem
                  title="All Resturant Owners"
                  link={Routes.AllResturantsOwner.path}
                />
                <NavItem
                  title="Pending Requests"
                  link={Routes.ResturantsOwnerPending.path}
                />
              </CollapsableNavItem>
              ...
              >
                <NavItem
                  ...
                  link={Routes.AllDeliveryPerson.path}
                />
                <NavItem
                  title="Pending Approval"
                  link={Routes.DeliveryPersonPending.path}
                />
              </CollapsableNavItem> */}
